...
Slice 9B.4 and later Milestone 9 work (resource workspace conversions starting with Items, quick record switching on production routes, dashboard summaries) have not started. Route Hubs remain deferred and unstarted. Deployment — previously listed as Milestone 8 — is a later milestone, is not complete, and has not started. Do not begin any of these until explicitly instructed in the milestone conversation.
