...
The rest of Slice 9B.5 (the deferred tabs' actual content), every other resource workspace conversion, and dashboard summaries have not started. Route Hubs remain deferred and unstarted. Deployment — previously listed as Milestone 8 — is a later milestone, is not complete, and has not started. Do not begin any of these until explicitly instructed in the milestone conversation.
