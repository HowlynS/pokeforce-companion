...
/**
 * Read-only availability probe for the Profession Page address field,
 ...
 */
export async function checkProfessionSlugAvailability(
  rawSlug: string,
  rawExcludeId?: string
  ...
  const taken = await isProfessionSlugTaken(prisma, slug, excludeId || undefined);
