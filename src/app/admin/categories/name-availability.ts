...
/**
 * Read-only availability probe for the Category name fields, invoked from
 ...
 */
export async function checkCategoryNameAvailability(
  rawName: string,
  rawExcludeId?: string
  ...
  const taken = await isCategoryNameTaken(prisma, name, excludeId || undefined);
