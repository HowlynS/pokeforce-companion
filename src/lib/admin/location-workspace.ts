 ...
 * deleted while any sub-location references it as its parent or any Shop
 * belongs to it.
 */
export function locationCanDelete(childCount: number, shopCount = 0): boolean {
  return childCount === 0 && shopCount === 0;
}
...
export function describeLinkedShops(count: number): string {
