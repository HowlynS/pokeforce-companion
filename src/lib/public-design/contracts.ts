...
export const PUBLIC_DESIGN_CONTRACTS = [
  ...
  },
  {
    ...
    scenicVariant: "detail",
    viewports: allPrimaryViewports,
    requiredRegions: [...shellRegions, "breadcrumb", "Profession identity", "Recipe count", "Verification"],
    optionalRegions: ["description", "Recipe directory", "Last updated"],
    interactions: ["toggle Recipe section", "switch Recipe layout", "open Recipe", "open resulting Item", "open Ingredient Item", "disclose additional Ingredients"],
    imageRequirement: "Neutral hero ContentImage/fallback without resource atmosphere",
    richTextRequirement: "Safe semantic authored description; hidden when empty",
    accessibility: [...shellA11y, "Recipe, result, and Ingredient links expose distinct context"],
    focusedTests: ["e2e/public-profession-details.spec.ts"],
    knownCaveats: ["Prototype Profession type is omitted because production has no such field"],
  },
  {
    id: "classes-index",
    ...
    optionalRegions: [],
    interactions: ["search Classes", "switch Class layout", "open Class"],
    imageRequirement: "Card ContentImage/fallback",
    richTextRequirement: "Plain compatibility description only in catalogue cards",
    accessibility: shellA11y,
    focusedTests: ["e2e/public-classes.spec.ts"],
    knownCaveats: ["PlayerClass is independent from Recipes; prototype focus, bonus, level, and gating fields are omitted"],
  },
  {
    id: "class-detail",
    label: "Class detail",
    ...
    interactions: ["follow breadcrumb", "open Classes catalogue from Resource chip"],
    imageRequirement: "Neutral hero ContentImage/fallback",
    richTextRequirement: "Safe semantic authored description; hidden when empty",
    accessibility: shellA11y,
    focusedTests: ["e2e/public-classes.spec.ts"],
    knownCaveats: [
      "No Class/Recipe relationship or prototype focus, bonus, or level fields exist",
    ],
  },
  {
    id: "categories-index",
  ...
  },
  {
    ...
    fixtures: ["locations-populated", "locations-no-results"],
    scenicVariant: "catalogue",
    viewports: allPrimaryViewports,
    requiredRegions: [
      ...shellRegions,
      ...
      "Location search",
      "type filter",
      "root/type hierarchy ledger",
    ],
    optionalRegions: ["empty search guidance"],
    interactions: [
      "search Locations",
      "filter by Location type",
      "collapse root/type folds",
      "open Location",
    ],
    imageRequirement: "52px card ContentImage/fallback with 34px content",
    richTextRequirement: "No description rendered in Location index cards",
    accessibility: shellA11y,
    focusedTests: ["e2e/public-locations.spec.ts", "e2e/public-navigation.spec.ts"],
    knownCaveats: [
      "Topmost production Locations provide the root groups; no World or NPC schema is inferred",
    ],
  },
  {
    id: "location-detail",
    ...
    fixtures: ["location-dense", "location-hierarchy-root"],
    scenicVariant: "detail",
    viewports: allPrimaryViewports,
    requiredRegions: [
      ...shellRegions,
    ...
    interactions: [
      "open ancestor/child Location",
      "collapse relationship sections",
      "toggle child grid/list",
      "open Shop",
      "open Item",
    ],
    imageRequirement: "180px hero stage with 128px ContentImage/fallback",
    richTextRequirement: "Safe semantic authored description; hidden when empty",
    ...
    knownCaveats: [
      "Verification is intentionally admin-only; nearby/Region and NPC prototype data are not inferred",
    ],
  },
  {
    id: "shops-index",
    ...
    requiredRegions: [
      ...
      "page heading",
      "Shop search",
      "root/Location-type hierarchy ledger",
    ],
    optionalRegions: ["result summary", "Clear search", "empty search guidance"],
    interactions: [
      "search Shops",
      "clear query",
      "collapse root/type folds",
    ...
    imageRequirement: "52px card stage with 34px ContentImage/fallback",
    richTextRequirement: "Description remains searchable but is omitted from compact cards",
    accessibility: [...shellA11y, "route-local search has a distinct accessible name"],
    focusedTests: ["e2e/public-shops.spec.ts"],
    knownCaveats: [
      "Shop has no type field; cards group by real root Location and Location type without a prototype Shop-type filter",
      "Search results are unpaginated",
    ],
  },
  {
    id: "shop-detail",
    ...
    requiredRegions: [
      ...
      "hierarchy breadcrumb",
      "180px Shop identity",
      "factual Location chips",
    ],
    optionalRegions: ["description", "Verification", "selectable Inventory", "listing notes"],
    interactions: [
      "open Region or Location",
      "collapse Inventory",
      "preview a listing",
      "open listed Item",
    ],
    imageRequirement: "128px hero and 72px/28px Inventory ContentImage/fallbacks preserve geometry",
    richTextRequirement: "Safe semantic authored description; hidden when empty",
    accessibility: [...shellA11y, "inventory is a semantic list of linked content"],
    focusedTests: ["e2e/public-shops.spec.ts"],
    knownCaveats: [
      "Shop has no production type, keeper, or NPC relationship; the identity uses factual Shop and Location data only",
      "Page metadata shares a cached query with page rendering",
    ],
  },
  {
    id: "search",
