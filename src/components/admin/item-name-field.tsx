...
// every resource) — the public props, the rendered markup, the live-region
// id, and every message are identical to the original Item implementation,
// so the Item pages and tests are unaffected.
