...
test("General and Acquisition Sources remain real links from the Used in Recipes tab, and no Item tab is disabled", async ({
  page,
}) => {
  const ITEM = {
  ...
  // remaining Item tab (General, Acquisition Sources, Used in Recipes)
